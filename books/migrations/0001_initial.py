    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='books_usertaggedbook_items', to='taggit.Tag')),
                ('tagger', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                 related_name='book_tags', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_object', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='books.Book')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='books_taggedbook_items', to='taggit.Tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(blank=True, choices=[
                 (1, 'Poor'), (2, 'Average'), (3, 'Good'), (4, 'Very Good'), (5, 'Excellent')], null=True)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_type', models.CharField(blank=True, choices=[
                 ('p', 'Paperback'), ('h', 'Hardcover'), ('o', 'Oversized')], default='p', max_length=1)),
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), (
                    'o', 'On loan'), ('a', 'Available'), ('r', 'Reserved')], default='a', max_length=1)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                 related_name='instances', to='books.Book')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='books.Series'),
        ),
        migrations.AddField(
            model_name='book',
            name='tags',
            field=taggit.managers.TaggableManager(
                blank=True, help_text='A comma-separated list of tags.', through='books.TaggedBook', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='book',
            name='user_tags',
            field=taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of tags.',
                                                  related_name='user_tags', through='books.UserTaggedBook', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='book',
            name='users_like',
