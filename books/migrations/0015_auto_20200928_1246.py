    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(max_length=3), blank=True, null=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='book_secondary_tags', to='books.SecondaryTags')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of tags.',
                                                  through='books.BookSecondaryTag', to='books.SecondaryTags', verbose_name='secondary tags'),
        ),
    ]
